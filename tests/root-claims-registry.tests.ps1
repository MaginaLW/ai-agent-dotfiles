...
try {
    ...
    Assert-ThrowsPattern { Assert-SealedLiveTransactionNamespaceJournalChildren -TransactionId '33333333-3333-4333-8333-333333333333' -ImmediateChildren @('Header.json') } '^live-transaction-namespace-child-not-allowed: 33333333-3333-4333-8333-333333333333/Header\.json$' 'the journal child contract rejects a case-variant fixed journal name'
    Assert-ThrowsPattern { Assert-SealedLiveTransactionNamespaceJournalChildren -TransactionId '33333333-3333-4333-8333-333333333333' -ImmediateChildren @('00001.json') } '^live-transaction-namespace-child-not-allowed: 33333333-3333-4333-8333-333333333333/00001\.json$' 'the journal child contract rejects a record name outside the six-digit pattern'
    $null = Assert-SealedLiveTransactionNamespaceJournalChildren -TransactionId '33333333-3333-4333-8333-333333333333' -ImmediateChildren @()
