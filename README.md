...
Local Windows dotfiles scaffold for Claude Code, Codex, and OpenCode configuration plus shared skill sources.

This repository is intentionally conservative:

- `skills-source/` is the only hand-maintained skill source tree.
- `claude/skills/`, `codex/skills/`, and `opencode/skills/` are generated by `scripts/build-skills.ps1` and ignored by Git.
