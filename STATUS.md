...
42 of 42 suites) on the candidates that carried those fixes - including `validation-c11-01` on
`6866e62`, whose host-roots snapshots taken mid-run and post-run are byte-identical. The only
